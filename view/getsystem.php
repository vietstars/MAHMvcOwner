	...
	<div class="install-page">
		...
		<p>
			<fieldset class="description">
		        ...
		        <div>
		        	<ul>
		             	<li>During installation you may see different status messages.</li>
                		<li>When there is an error message you must correct the error to continue.</li>
                		<li>If you see a warning message you should take notice before you proceed.</li>
                		<li>If you are unsure of an option value, you may keep the default setting.</li>
		            </ul>
		        </div>
		    </fieldset>
		    <fieldset class="info">
