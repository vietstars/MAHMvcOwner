                ...
                <div class="card-head style-primary">
                  ...
                  <div class="tools fixed-action-btn">
                    ...
                    <ul data-activity="#product-list">
                      ...
                      <li><a class="btn btn-floating btn-danger multi-refund-btn"><i class="fa fa-mail-reply" data-toggle="tooltip" data-placement="left" title="Multiple refund"></i></a></li>
                      <li><a class="btn btn-floating btn-info multi-agree-btn"><i class="fa fa-check" data-toggle="tooltip" data-placement="left" title="Multiple agreement"></i></a></li> 
                    </ul>
                  </div>
                </div>
