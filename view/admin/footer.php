	...
	<div id="menubar" class="menubar-inverse  animate">
	  	<div class="menubar-fixed-panel">
	        <div>
	          	<a class="btn btn-icon-toggle btn-default menubar-toggle" data-toggle="menubar" href="#">
	      		...
	      		<div class="menubar-scroll-panel" style="padding-bottom: 33px;">
			        ...
			        <div class="menubar-foot-panel">
			          <small class="no-linebreak hidden-folded">
			            <span class="opacity-75">Copyright © <?=date('Y')?></span> <strong>Vietstar</strong>
			          </small>
			        </div>
		      	</div>
	      	</div>
		    ...
		    <ul class="list ">
		      ...
		      <li class="tile">
		        <a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
		          <div class="tile-icon">
		            <img src="<?=$this->modun('image')->getImg('1502769675_user2_160x160.jpg','avatar')?>" alt="">
		          </div>
		          <div class="tile-text">
		            Alex Nelson
		...
		<div id="offcanvas-chat" class="offcanvas-pane style-default-light width-12">
		  ...
		  <div class="offcanvas-body">
		    <ul class="list-chats">
		      <li>
		        <div class="chat">
		          <div class="chat-avatar"><img class="img-circle" src="<?=$this->modun('image')->getImg('1502769675_user2_160x160.jpg','avatar')?>" alt=""></div>
		          <div class="chat-body">
