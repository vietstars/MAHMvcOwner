                ...
                <div class="card-head style-primary">
                  ...
                  <div class="tools fixed-action-btn">
                    ...
                    <ul data-activity="#manager-list">
                      ...
                      <li><a class="btn btn-floating btn-primary multi-lock-btn"><i class="fa fa-plus" data-toggle="tooltip" data-placement="left" title="New user"></i></a></li>
                    </ul>
                  </div>
                </div>
                <div class="card-tiles">
                  <div class="hbox-md col-md-12">
                  <table id="manager-list" class="table table-bordered table-hover dataTable table-responsive">
                    <thead>
                    <tr>
